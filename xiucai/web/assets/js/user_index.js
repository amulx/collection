        ...
        if(loadInfo.rType == 'new'){
            ...
            if(str == today_date){
                if(live.time_left == 0){
                    var countdown =
                        '<ul>'+
                        '<li style="color: #ed7101;font-size: 18px;height: 70px;line-height: 70px;">正在直播。。。</li>'+
                        '</ul>';
                }else{
                    var countdown = '<ul style="height: 70px;" class="countdown" data-diff="'+live.time_left+'">'+
                        '<li class="hour">'+
                    ...
                    '<div class="app_r">'+countdown+
                        '<div style="padding-top: 15px;" class="content" '+content_h+'>'+
                            '<div class="div_pic fl">'+
                                '<a href="'+course_live_detail+'/'+live.id+'" target="_blank">' +
                                    '<img width="280" height="192" src="'+live.img_url+'" style="border:1px solid #CCCCCC;">' +
                                '</a>'+
                            '</div>'+
                            '<div class="word">'+
