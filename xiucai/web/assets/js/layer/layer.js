    ...
    function(a, b) {
        ...
        h.pt = h.prototype, h.pt.config = {
            ...
            var b = this,
                ...
                d = b.config,
                e = d.dialog,
                f = -1 === e.type ? "" : '<span class="xubox_msg xulayer_png32"></span>',
            ...
            d.border[0] && (j = '<div id="xubox_border' + c + '" class="xubox_border" style="' + o + '"></div>'), !d.maxmin || 1 !== d.type && 2 !== d.type || /^\d+%$/.test(d.area[0]) && /^\d+%$/.test(d.area[1]) || (n = '<a class="xubox_min" href="javascript:;"><cite></cite></a><a class="xubox_max xulayer_png32" href="javascript:;"></a>'), d.closeBtn[1] && (n += '');
